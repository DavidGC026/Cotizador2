...
$sql_ventas_mes = "SELECT id_productos, productos, cantidades FROM cotizacionesf WHERE Fecha >= DATE_SUB(NOW(), INTERVAL 1 MONTH) LIMIT 20";
...
<head>
    <meta charset="UTF-8">
    <title>Estadísticas de Cotizaciones Mensuales</title>
...
<body>
    <div class="container">
        <h1>Estadísticas de Cotizaciones Mensuales</h1>

        <!-- Tarjeta para el gráfico de ventas mensuales -->
        <div class="card mb-4">
            <div class="card-body">
                <h2 class="card-title">Gráfico de Cotizaciones Mensuales</h2>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            $sql_id_productos_all = "SELECT id_productos FROM cotizacionesf WHERE Fecha >= DATE_SUB(NOW(), INTERVAL 1 MONTH) ORDER BY cantidades DESC LIMIT 20";
