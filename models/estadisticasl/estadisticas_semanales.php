...
$sql_ventas_mes = "SELECT id_productos, productos, cantidades FROM cotizacionesf WHERE Fecha >= DATE_SUB(NOW(), INTERVAL 1 WEEK) LIMIT 20";
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            $sql_id_productos_all = "SELECT id_productos FROM cotizacionesf WHERE Fecha >= DATE_SUB(NOW(), INTERVAL 1 WEEK) ORDER BY cantidades DESC LIMIT 20";
            ...
            options: {
                ...
                plugins: {
                    legend: {
                        labels: {
                            font: {
                                size: 10 // Ajuste de tamaño de fuente para los títulos
                            }
                        }
                    },
                    tooltip: {
                        mode: 'index', // Mostrar todos los elementos que comparten la misma etiqueta en la misma línea
                        intersect: false // Permitir que el puntero del ratón se deslice a través de las barras sin activarlas
                    }
                }
            }
        });
