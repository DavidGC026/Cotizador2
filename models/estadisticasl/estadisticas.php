...
<body>
    ...
    <div class="container">
        ...
        <div class="card mt-3">
            <div class="card-header">
                <h2 class="card-title">Productos menos vendidos</h2>
            </div>
            <div class="card-body">
