...
<body>
    ...
    $sql_general = "SELECT * FROM Webinars";
    ...
    <table>
        <tr>
            ...
            <td>
                <form method="post" action="generar_factura3.php" id="pdfForm" target="_blank">
                    <table border="0px">
                        <tr>
                            <td>
    ...
    <script>
        ...
        function mostrarResultado(data) {
            ...
            table.innerHTML = '<tr><th>ID</th><th>Nombre</th><th>Descripcion</th><th>Costo</th><th>Modulos</th><th>Cantidad</th><th>Descuento</th><th>Total</th><th>Total con Descuento</th><th>Seleccionar</th></tr>';
            ...
            data.forEach(item => {
                ...
                campo1Cell.textContent = item.nombre;
                ...
                campo4Cell.textContent = item.modulos;
    ...
    document.getElementById('datosTabla').value = JSON.stringify(obtenerDatosTabla());
        ...
        function obtenerDatosTabla() {
            ...
            for (var i = 1; i < table.rows.length; i++) {
                ...
                var modulos = row.cells[4].textContent;
