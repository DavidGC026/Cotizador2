...
<body>
    ...
    $sql_general = "SELECT * FROM cursos";
    ...
    <table>
        <tr>
            ...
            <td>
                <form method="post" action="generar_factura2.php" id="pdfForm" target="_blank">
                    <table border="0px">
                        <tr>
                            <td>
    ...
    <script>
        ...
        function mostrarResultado(data) {
            ...
            table.innerHTML = '<tr><th>ID</th><th>Nombre</th><th>Descripcion</th><th>Costo</th><th>Modalidad</th><th>Cantidad</th><th>Descuento</th><th>Total</th><th>Total con Descuento</th><th>Seleccionar</th></tr>';
            ...
            data.forEach(item => {
                ...
                campo4Cell.textContent = item.modalidad;
    ...
    document.getElementById('datosTabla').value = JSON.stringify(obtenerDatosTabla());
        ...
        function obtenerDatosTabla() {
            ...
            for (var i = 1; i < table.rows.length; i++) {
                ...
                var modalidad = row.cells[4].textContent;
